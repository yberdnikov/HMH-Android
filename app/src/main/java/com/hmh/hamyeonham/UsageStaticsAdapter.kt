...
class UsageStaticsAdapter(private val appUsageList: List<UsageStat>, private val context: Context) :
    RecyclerView.Adapter<UsageStaticsViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): UsageStaticsViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        return UsageStaticsViewHolder(ItemUsagestaticBinding.inflate(inflater, parent, false), context)
    }
